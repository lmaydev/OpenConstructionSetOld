...
## OcsService.FindAllInstallations() Method
Search using all installation locators and return any positive results.  
```csharp
public System.Collections.Generic.Dictionary<string,OpenConstructionSet.Models.Installation> FindAllInstallations();
```
#### Returns
...
Implements [FindAllInstallations()](CSd0KkG23rZ8mZ8TezRJWQ 'OpenConstructionSet.IOcsService.FindAllInstallations()')  
