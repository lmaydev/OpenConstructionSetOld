...
namespace OpenConstructionSet.Mods
{
    ...
    public class ModFileInfo
    {
        ...
        /// </summary>
        public ModFileInfo() : this(0, "", "", Array.Empty<string>(), 0, DateTime.Now)
        {
        }
        ...
        public ModFileInfo(uint id, string mod, string title, string[] tags, byte visibility, DateTime? lastUpdate)
        {
            Id = id;
            Mod = mod;
            Title = title;
