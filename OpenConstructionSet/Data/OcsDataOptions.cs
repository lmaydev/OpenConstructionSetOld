...
/// <param name="Installation">An <c>Installation</c> object to use when searching for a mods full path. If no installation object or name is provided discovery will be attempted.</param>
