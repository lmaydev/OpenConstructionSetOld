...
/// <param name="Installation">An <c>Installation</c> object to use when searching for a mods full path and later by the <c>OcsDataContext</c>. If <c>null</c> discovery will be attempted.</param>
